...
local helpText = {
    "Control the paddle using arrow keys or A/D!",
    "",
    "Features:",
    "• Multiple brick types with different colors and points",
    "• Power-ups: Multi-ball, Sticky Paddle, Expand Paddle, Laser, Extra Life",
    "• Moving bricks that slide horizontally",
    "• Progressive levels with increasing difficulty",
    "• Beautiful neon visuals and particle effects",
    "",
    "Brick Types:",
    "• Red: 10 points, 1 health",
    "• Blue: 20 points, 1 health",
    "• Orange: 50 points, 2 health, Multi-ball power-up",
    "• Purple: 30 points, 1 health, Sticky paddle",
    "• Green: 40 points, 1 health, Expand paddle",
    "• Pink: 60 points, 3 health, Laser power-up",
    "• Yellow: 25 points, 1 health, Extra life",
    "",
    "Power-ups:",
    "• Multi-ball (M): Adds two extra balls",
    "• Sticky (S): Ball sticks to paddle for 10 seconds",
    "• Expand (E): Makes paddle wider for 8 seconds",
    "• Laser (L): Activates laser guns for 6 seconds",
...
function Menu:draw(screenWidth, screenHeight, state)
    -- Draw animated title
    love.graphics.setColor(0.2, 0.7, 1.0) -- Blue theme for Breakout
    ...
    if state == "menu" then
        if self.showHelp then
            ...
            love.graphics.printf("Smash Through the Neon Grid!",
    ...
    love.graphics.setFont(self.smallFont)
    love.graphics.printf("© 2025 Jericho Crosby – Neon Breakout", 10, screenHeight - 25, screenWidth - 20, "right")
end
...
function Menu:drawHelpOverlay(screenWidth, screenHeight)
    ...
    -- Box border
    love.graphics.setColor(0.2, 0.7, 1.0) -- Blue theme
        ...
        if button.section == section then
            ...
            if button.action:sub(1, 4) == "diff" then
                ...
                if difficulty == self.difficulty then
                    love.graphics.setColor(0.2, 0.7, 1.0, 0.4) -- Blue highlight
